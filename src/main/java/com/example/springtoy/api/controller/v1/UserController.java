package com.example.springtoy.api.controller.v1;
...
import com.example.springtoy.api.model.response.ListResult;
import com.example.springtoy.api.model.response.SingleResult;
...
public class UserController {
    ...
    public SingleResult<User> findUserById(@ApiParam(value = "회원ID", required = true) @PathVariable Long userId)throws CUserNotFoundException {
    ...
    public SingleResult<User> save(@ApiParam(value = "회원아이디", required = true) @RequestParam Long uid,
                                   @ApiParam(value = "회원 이메일", required = true) @RequestParam String msrl,
    ...
    public SingleResult<User> modify(
            ...
            @ApiParam(value = "회원아이디", required = true) @RequestParam Long uid,
            @ApiParam(value = "회원이름", required = true) @RequestParam String name) {
        User user = User.builder()
                .msrl(msrl)
                .uid(uid)
